...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div id="form">
        <div id="titulo-form">
            HACKATHON - CADASTRAR PROFESSOR
        </div>
        
        <!-- Login -->
        <form name="frmlogin" method="post" action="cadastrarProfessor.php">
            <label class="label-login">Professor</label><br>
            <input type="text" class="txtForm"  name="login" placeholder="Digite o nome do Professor"><br>
